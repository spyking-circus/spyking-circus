...
def main(filename, params, nb_cpu, nb_gpu, use_gpu):
    ...
    if extraction == 'quadratic':
        ...
        if parallel_hdf5:
            ...
            templates  = hfile.create_dataset('templates', shape=(N_e, N_t, 2*local_nb_clusters), dtype=numpy.float32, chunks=True, compression='lzf')
        ...
        if parallel_hdf5:
            ...
            if comm.rank == 0:
                ...
                cfile      = h5py.File(file_out_suff + '.clusters.hdf5', 'r+', libver='latest')
                templates  = hfile.create_dataset('templates', shape=(N_e, N_t, 2*n_clusters), dtype=numpy.float32, chunks=True, compression='lzf')
