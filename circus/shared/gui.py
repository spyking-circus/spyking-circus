    ...
    def generate_data(self):
        ...
        def reversed_corr(spike_1, spike_2, max_delay):
            ...
            if (len(spike_1) > 0) and (len(spike_2) > 0):
                ...
                p1 = len(spike_1) / self.nb_bins
                p2 = len(spike_2) / self.nb_bins
                control = p1 * p2
            ...
            x_cc = x_cc / (self.cc_bin * 1e-3) ** 2  # invariant with the duration and cc_bin (in the end)
            control = control / (self.cc_bin * 1e-3) ** 2  # invariant with the duration (in the end)
